...
def main():
    ...
    criterion = CB_Loss(loss_type="binary_cross_entropy",1, class_counts[0]/class_counts[1], class_counts[0]/class_counts[2], class_counts[0]/class_counts[3], class_counts[0]/class_counts[4])
