...
class CB_loss(nn.Module):
    ...
    """
    def __init__(self, samples_per_cls, no_of_classes=cfg.DATA.NUM_CLASSES, loss_type="focal", beta=0.9999, gamma=2.0):
    ...
    def forward(self, labels, logits):    
        ...
        print("Dimensions of weights:", weights.shape)
        print("Dimensions of labels_one_hot:", labels_one_hot.shape)
        weights = weights.repeat(labels_one_hot.shape[0],1) * labels_one_hot.t()
