...
class ContextPath(nn.Module):
    def __init__(self, backbone='xception39', pretrained_base=None, norm_layer=nn.BatchNorm2d, **kwargs):
        super(ContextPath, self).__init__()
        if backbone == 'xception39':
            pretrained = xception39(pretrained_model= pretrained_base, **kwargs)
        else:
