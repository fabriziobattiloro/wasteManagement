...
class BiSeNet(nn.Module):
    def __init__(self, nclass, backbone='xception39', aux=False, jpu=False, pretrained_base=False, **kwargs):
...
if __name__ == '__main__':
    ...
    model = BiSeNet(19, backbone='xception39')
